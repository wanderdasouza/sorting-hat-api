...
export class ServiceController {
  ...
  @Post()
  async create(@Body() serviceDto: ServiceDto, @Param('mid') moduleId: number) {
    return this.serviceService.create(serviceDto, moduleId);
  }
  ...
  async createOperation(
    @Body() operationServiceDto: OperationserviceDto,
  ...
  async createExternalResource(
    @Body() externalResourcesDto: ExternalResourceDto,
    @Param('sid') serviceId: number,
  ) {
    return this.serviceService.createExternalResource(
  ...
  async createCommunication(
    ...
    return this.serviceService.createCommunication(
      communicationdDto,
      serviceId,
      receiverId,
    );
